...
, instanceId) {
  ...
  const series = indicatorSeriesRef.current?.[instanceId || "ICHIMOKU"];
  if (!series) return;
  ...
  latestIndicatorValuesRef.current[instanceId || "ICHIMOKU"] = {
  ...
  indicatorSeriesRef.current[instanceId || "ICHIMOKU"].result = {
    data: {
